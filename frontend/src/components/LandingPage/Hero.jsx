      ...
      >
        <Stack spacing={2} useFlexGap sx={{ width: { xs: '100%', sm: '70%' } }}>
          ...
          <Typography textAlign="center" color="text.secondary" sx={{ alignSelf: 'center', width: { sm: '100%', md: '80%' } }}>
            Explore our AI-driven platform for seamless form creation and efficient data collection. Benefit from a unique token-based
            system that rewards user engagement and integrated visualization tools for faster, smarter data insights.
          </Typography>
          <Stack
        ...
        <Box
          ...
          sx={(theme) => ({
            ...
            width: '100%',
            backgroundImage: (theme.palette.mode === theme.palette.mode) === 'light' ? `url(${heroImage})` : `url(${heroImage})`,

          ...
          >
            ...
            >
              ...
              <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                <MenuItem onClick={() => scrollToSection('Home')} sx={{ py: '6px', px: '12px' }}>
            ...
            >
              ...
              <Button color="primary" variant="text" size="small" component="a" href="/login" target="_blank">
                Login
              </Button>
            ...
            <Box sx={{ display: { sm: '', md: 'none' } }}>
              ...
              <Drawer anchor="right" open={open} onClose={toggleDrawer(false)}>
                ...
                >
                  ...
                  <Divider />
                  <MenuItem>
                    <Button color="primary" variant="contained" component="a" href="/register" target="_blank" sx={{ width: '100%' }}>
                      Register
                    </Button>
                  </MenuItem>
                  <MenuItem>
                    <Button color="primary" variant="outlined" component="a" href="/login" target="_blank" sx={{ width: '100%' }}>
                      Login
                    </Button>
                  </MenuItem>
                </Box>

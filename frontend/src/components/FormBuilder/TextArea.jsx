...
const TextArea = ({ item, handleValue, deleteEl, handleRequired, handleElType, duplicateElement }) => {
  return (
    <Fragment>
      <Paper elevation={1}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={9}>
              <TextField
                ...
                sx={{ mb: 2 }}
              />
              <TextField variant="outlined" fullWidth placeholder="TextareaIInput Field" disabled multiline rows={3} />
            </Grid>
            <Grid item xs={3}>
